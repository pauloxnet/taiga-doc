...
build-essential binutils-doc autoconf flex bison libjpeg-dev libfreetype6-dev libxml2-dev libxslt1-dev \
...
[source,bash]
----
sudo apt-get install -y postgresql-9.5 postgresql-contrib-9.5 postgresql-doc-9.5 postgresql-server-dev-9.5
----
